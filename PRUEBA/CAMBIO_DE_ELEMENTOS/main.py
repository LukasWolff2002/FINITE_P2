    ...
    for cell_block in mesh.cells:
        ...
        if cell_block.type == "quad": #Ojjo aqui
            for i, node_ids in enumerate(cell_block.data):
                ...
                if i + 1 == 34:  # Identificar el elemento 34 (Quad9)
                    # Los nodos del Quad9 (12 nodos en total) se distribuyen en dos Quad4:
                    # Nodo 1, Nodo 2, Nodo 5, Nodo 6 => Primer Quad4
                    # Nodo 2, Nodo 3, Nodo 6, Nodo 7 => Segundo Quad4

                    # Primer Quad4
                    quad4_1_nodes = [node_ids[0], node_ids[1], node_ids[4], node_ids[5]]
                    elements.append(Element(i + 1, quad4_1_nodes, 4))  # Crear el primer elemento Quad4

                    # Segundo Quad4
                    quad4_2_nodes = [node_ids[1], node_ids[2], node_ids[5], node_ids[6]]
                    elements.append(Element(i + 2, quad4_2_nodes, 4))  # Crear el segundo elemento Quad4
                else:
